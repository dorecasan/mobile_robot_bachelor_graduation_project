...
echo_and_run cd "/home/dorecasan/my_ros/robot_lab/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/home/dorecasan/my_ros/robot_lab/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/dorecasan/my_ros/robot_lab/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
