...
echo_and_run cd "/home/dorecasan/my_ros/robot_lab/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/home/dorecasan/my_ros/robot_lab/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/dorecasan/my_ros/robot_lab/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
