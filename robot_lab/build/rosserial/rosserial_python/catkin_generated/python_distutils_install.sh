...
echo_and_run cd "/home/dorecasan/my_ros/robot_lab/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/home/dorecasan/my_ros/robot_lab/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/dorecasan/my_ros/robot_lab/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
